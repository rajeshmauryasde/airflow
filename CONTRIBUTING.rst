...
facebook, firebolt, ftp, gcp, gcp_api, github_enterprise, google, google_auth, grpc, hashicorp,
hdfs, hive, http, imap, influxdb, jdbc, jenkins, jira, kerberos, kubernetes, ldap, leveldb,
